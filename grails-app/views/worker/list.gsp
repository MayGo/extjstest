			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="idCode" title="${message(code: 'worker.idCode.label', default: 'Id Code')}" />
					
						<th><g:message code="worker.division.label" default="Division" /></th>
				...
				<g:each in="${workerInstanceList}" status="i" var="workerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: workerInstance, field: "idCode")}</td>
					
						<td>${fieldValue(bean: workerInstance, field: "division")}</td>
